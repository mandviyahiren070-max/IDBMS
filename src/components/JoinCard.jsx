...
const JoinCard = ({ title, image }) => {
  return (
    <div className="group relative w-full aspect-[3/4] rounded-2xl cursor-pointer overflow-hidden
                    bg-black border-2 border-transparent shadow-lg
                    transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.7)]">
